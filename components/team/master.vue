	...
	export default{
		...
		methods:{
					...
					(res) => {
						...
						if(data.data.length>0){
							if(type==1){
								...
								this.masterInfo = this.masterInfo.concat(data.data);
							}
							
							if(this.masterInfo.length<20){
			...
			loadMore(){
				...
				this.getMasterInfo(2);
			},
			//下拉刷新
			refresh(){
				this.currentPage = 1;
				this.getMasterInfo(1);
			},
		},
	}
</script>
