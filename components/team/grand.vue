				...
				this.$jytools.url_request(this.$url.getMyTeamListV3, {
					...
					(res) => {
						...
						if(data.data.length>0){
							if(type==1){
								this.grandInfo = data.data;
							}
							else if(type==2){
								this.grandInfo = this.grandInfo.concat(data.data);
							}
							
							if(this.grandInfo.length<20){
